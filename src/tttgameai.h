...
// Returns: Nothing
// Note: Be sure to generate the child classes in order,
//		So given the board from lecture, the child at index 0 should be the board
//		where X moved to 2. The second item in the vector should be where X moved
//		to 8, etc.
